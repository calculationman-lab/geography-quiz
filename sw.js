const CACHE="social-quiz-v5";
const AUDIO_REVISION="20260813-v5";
const ASSETS=["./","./index.html","./styles.css","./questions.js","./app.js",`./se-correct.mp3?v=${AUDIO_REVISION}`,`./se-wrong.mp3?v=${AUDIO_REVISION}`,"./manifest.webmanifest","./icon-192.png","./icon-512.png"];
