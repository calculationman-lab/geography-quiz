...
(async()=>{
  ...
  for(const asset of ['./styles.css?v=20260926-v11-3','./countdown.js?v=20260926-v11-3-r1','./app.js?v=20260926-v11-3-r1'])assert(cached.has(asset),`更新資産を先読み: ${asset}`);
