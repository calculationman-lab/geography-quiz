const CACHE="social-quiz-v6";
const AUDIO_REVISION="20260814-v6";
const ASSETS=["./","./index.html","./styles.css","./questions.js?v=20260814-v6","./app.js?v=20260814-v6",`./se-correct.mp3?v=${AUDIO_REVISION}`,`./se-wrong.mp3?v=${AUDIO_REVISION}`,"./manifest.webmanifest","./icon-192.png","./icon-512.png"];
