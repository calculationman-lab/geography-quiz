const CACHE="social-quiz-v11-3-countdown-exam-r2";
const AUDIO_REVISION="20260920-v11-2";
const ASSETS=["./","./index.html","./styles.css?v=20260926-v11-3-r2","./questions.js?v=20260920-v11-2","./lower-questions.js?v=20260920-v11-2","./weekly-review.js?v=20260920-v11-2","./countdown.js?v=20260926-v11-3-r1","./app.js?v=20260926-v11-3-r1",`./se-correct.mp3?v=${AUDIO_REVISION}`,`./se-wrong.mp3?v=${AUDIO_REVISION}`,"./manifest.webmanifest","./icon-192.png?v=20260920-v11-2","./icon-512.png?v=20260920-v11-2","./apple-touch-icon.png?v=20260920-v11-2"];
